...
**2026-09-22 更新：** 本節列的 known pendulum 與 energy 兩項已由獨立規格 [V1_DYNAMIC_REFERENCE_SUITE_SPEC](V1_DYNAMIC_REFERENCE_SUITE_SPEC.md) 以凍結門檻執行完成（6/6 PASS，[receipt](receipts/V1_DYNAMIC_REFERENCE_SUITE_RECEIPT_2026-09-22.md)）；dynamic contact 的單剛體部分由 [V1_CONTACT_REFERENCE_SUITE_SPEC](V1_CONTACT_REFERENCE_SUITE_SPEC.md) 完成（7/7 gate PASS、預登記 Coulomb 假說 rejected，[receipt](receipts/V1_CONTACT_REFERENCE_SUITE_RECEIPT_2026-09-22.md)）；關節式人形的 dynamic contact 與致動下的能量帳仍為下一批。
