...
| V1-R11 numerical convergence | time-step, solver tolerance and finite-difference study | metric/residual convergence under preregistered criterion | convergence table + raw runs | V1 | PARTIAL: passive 4/2/1 ms normalized-GRF stability PASS，observed order依 frozen round-off semantics為 null；articulated dynamic、solver-tolerance與 finite-difference studies仍缺 |
